...
void main() {
  ...
  test('Initial state', () => expect(ChartGendersBloc(genshinService).state, const ChartGendersState.loading(), reason: 'A freshly built ChartGendersBloc must start in loading before init'));
