...
void main() {
  ...
  test(
    'Initial state',
    () => expect(ChartElementsBloc(genshinService).state, const ChartElementsState.loading(), reason: 'A freshly built ChartElementsBloc must start in loading before init'),
  );
