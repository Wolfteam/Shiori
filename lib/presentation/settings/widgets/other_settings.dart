      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          BlocBuilder<SettingsBloc, SettingsState>(
            builder:
                (context, state) => state.map(
                  loading: (_) => const Loading(useScaffold: false),
                  loaded:
                      (settingsState) => Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          SwitchListTile(
                          ...
                          SwitchListTile(
                            ...
                            onChanged:
                                (newVal) => context.read<SettingsBloc>().add(
                                  SettingsEvent.useTwentyFourHoursFormatChanged(newValue: newVal),
                                ),
                          ),
                          SwitchListTile(
                            ...
                            onChanged:
                                (newVal) => context.read<SettingsBloc>().add(
                                  SettingsEvent.checkForUpdatesOnStartupChanged(newValue: newVal),
                                ),
                          ),
