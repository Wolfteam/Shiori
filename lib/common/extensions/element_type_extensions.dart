...
extension ElementTypeExtensions on ElementType {
  ...
  Color getElementColor() {
    ...
    switch (this) {
      case ElementType.anemo:
        color = Color.fromARGB(255, 161, 241, 201);
        break;
      case ElementType.cryo:
        color = Color.fromARGB(255, 194, 249, 251);
        break;
      case ElementType.dendro:
        color = Color.fromARGB(255, 144, 200, 6);
        break;
      case ElementType.electro:
        color = Color.fromARGB(255, 203, 127, 252);
        break;
      case ElementType.geo:
        color = Color.fromARGB(255, 242, 211, 92);
        break;
      case ElementType.hydro:
        color = Color.fromARGB(255, 4, 225, 250);
        break;
      case ElementType.pyro:
        color = Color.fromARGB(255, 249, 163, 104);
        break;
      default:
        throw Exception('Invalid element type = ${this}');
    }
